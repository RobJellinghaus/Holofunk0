...
namespace Holofunk
{
    ...
    public abstract class Parameter
    {
        ...
        public abstract float this[Moment now] { get; set; }
        ...
        public float GetInterpolatedValue(Moment now)
        {
    ...
    public sealed class ConstantParameter : Parameter
    {
        ...
        public ConstantParameter(ParameterDescription description) 
            : this(
                ...
                (float)((description.Default - description.Min) / (description.Max - description.Min)), 
                false)
        {
        }

        public override float this[Moment now]
        {
            get 
            { 
                return m_value; 
