...
{
    /// <summary>
    /// A contiguous array of samples in memory.
    /// </summary>
    /// <remarks>
    /// This is a slice out of a larger Chunk.
    /// 
    ...
    /// and the term "sample length" to mean "the total number of measurement samples, e.g. data points".
    /// </remarks>
    public struct Sample<T>
    {
        ...
        internal Sample(Chunk<T> chunk, int index, int length)
        {
            ...
            Debug.Assert(index + length <= chunk.Capacity);
        ...
        /// <summary>
        /// Has this Sample<typeparam name="T"/> actually been constructed (if false, it's default)?
        /// </summary>
        internal bool IsInitialized { get { return m_chunk != null; } }

        /// <summary>
        /// The Chunk containing the actual data of this Sample.
        /// </summary>
        internal Chunk<T> Chunk { get { return m_chunk; } }

        /// <summary>
        /// The starting index of the data bracketed by this Sample.
        /// </summary>
        internal int Index { get { return m_index; } }

        /// <summary>
        /// The number of individual T's in the sequence bracketed by this Sample.
        /// </summary>
        ...
        public void Spam()
        {
            Holofunk.Core.Spam.Write("[chunk #");
            Holofunk.Core.Spam.Write(Chunk.Id);
            Holofunk.Core.Spam.Write(", start pos ");
            Holofunk.Core.Spam.Write(Index);
            Holofunk.Core.Spam.Write(", length ");
            Holofunk.Core.Spam.Write(Length);
            Holofunk.Core.Spam.Write("]");
        }
    }
    ...
    {
        /// <summary>
        /// Copy the contents of the given buffer into this sample; use this sample's length.
        /// </summary>
        ...
        /// <summary>
        /// Copy all data from otherSample to thisSample.
        /// </summary>
        public static void CopyFrom(this Sample<float> thisSample, Sample<float> otherSample)
        {
            Debug.Assert(thisSample.Length == otherSample.Length);
